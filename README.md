...
### Tools:
![My Skills](https://skillicons.dev/icons?i=linux,bots,django,flask,sqlite,mysql,postgresql,git,github,githubactions,vim,vscode,arduino,fastapi,md,postman,powershell,bash,stackoverflow)
### FrontEnd/BackEnd:
![My Skills](https://skillicons.dev/icons?i=html,css,sass,js,jquery,nodejs,bootstrap,figma,wordpress)
## Contacts:
